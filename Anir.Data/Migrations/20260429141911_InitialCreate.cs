        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThemeMode = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolLevel = table.Column<int>(type: "integer", nullable: true),
                    Sex = table.Column<int>(type: "integer", nullable: true),
                    Affiliation = table.Column<int>(type: "integer", nullable: true),
                    ExecutiveRole = table.Column<int>(type: "integer", nullable: true),
                    Militancy = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackupToolPath = table.Column<string>(type: "text", nullable: true),
                    ...
                    AutoMaintenanceEnabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperimentalStartDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExperimentalEndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipationPercentage = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnirWorkPersons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnirWorkPersons_AnirWorks_AnirWorkId",
                        column: x => x.AnirWorkId,
                        principalTable: "AnirWorks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnirWorkPersons_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnirWorkPresentations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnirWorkPresentations_AnirWorks_AnirWorkId",
                        column: x => x.AnirWorkId,
                        principalTable: "AnirWorks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnirWorkPersons_AnirWorkId_PersonId",
                table: "AnirWorkPersons",
                columns: new[] { "AnirWorkId", "PersonId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AnirWorkPersons_PersonId",
                table: "AnirWorkPersons",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_AnirWorkPresentations_AnirWorkId",
                table: "AnirWorkPresentations",
                column: "AnirWorkId");
