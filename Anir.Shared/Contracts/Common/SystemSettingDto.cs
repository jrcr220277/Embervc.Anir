...
public class SystemSettingDto
{
    ...
    [StringLength(500, ErrorMessage = "La ruta no puede exceder {1} caracteres.")]
    [Display(Name = "Ruta de la herramienta de respaldo (pg_dump)")]
    public string? BackupToolPath { get; set; }

    [Range(1, 50, ErrorMessage = "Debe mantener entre 1 y 50 respaldos.")]
    [Display(Name = "Cantidad máxima de respaldos a conservar")]
    public int MaxBackupFiles { get; set; } = 5;

    [Display(Name = "Activar respaldo automático")]
    public bool AutoBackupEnabled { get; set; }

    [Display(Name = "Activar limpieza automática")]
    public bool AutoMaintenanceEnabled { get; set; }

    [Display(Name = "Hora de ejecución (Formato 24h)")]
